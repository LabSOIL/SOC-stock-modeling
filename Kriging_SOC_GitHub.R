...
# Load data points
Data_Points <- read_excel("Data_Points_Supplementary_Material.xlsx")
...
# This part isn't necessary if you have the file with all the data already calculated
...
# write_xlsx(FE_Abundance, path = "Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/Excel Tables/Meta/Stocks_Per_Horizon.xlsx")
# 
...
# write_xlsx(Data_Points, path = "Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/Excel Tables/Meta/Data_Points_With_Stocks.xlsx")
# 
...
# Points_Altitude <- read_excel("Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/Excel Tables/Meta/MetaData50.xlsx", sheet = "Plots")
# 
...
# Write to Excel
write_xlsx(results_df, path = "Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/GIS/SOC Map/O.xlsx")
...
# Write to Excel
write_xlsx(results_df, path = "Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/GIS/SOC Map/PCs_Site_By_Site_22_10.xlsx")
...
# Write to Excel
write_xlsx(results_df, path = "Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/GIS/SOC Map/Mean_Model_03_11.xlsx")
...
# Write to Excel
write_xlsx(results_df, path = "Y:/common/STAFF/Bence Dienes/Project/OBJECTIVE 1/GIS/SOC Map/NDVI_Elevation_10_11.xlsx")
...
file_paths <- c(
  ...
  "PCs_Site_By_Site_100_Seeds_22_10.xlsx"
)
...
Free_Predictors_Comparison <- plot_evaluation_metric(
  ...
  evaluation_filter = c("Regression"),
  # loop_name = "Original Variables",
  x_var = "Area",
  fill_var = "Predictor_Set",
  y_label = "RMSE [MgC/ha]",
...
Make_SOC_Map <- function(area = c("Réchy", "Binntal"),
  ...
  # 10 — Save map
  # -----------------------------
  png(output_path, width = 8, height = 6, units = "in", res = 300)
  plot(raster_result,
       main = "",
       col = viridis(100),
       axes = TRUE,
